...
# ───────────────────────────────────────────────
# 📂 Đường dẫn chuẩn theo cấu trúc project
# ───────────────────────────────────────────────
...
# ───────────────────────────────────────────────
# RULE 1: Transaction >=10M must use OTP or Biometric
# ───────────────────────────────────────────────
...
# ───────────────────────────────────────────────
# RULE 2: Device must be verified or trusted
# ───────────────────────────────────────────────
...
# ───────────────────────────────────────────────
# RULE 3: Daily total > 20M but no strong auth
# ───────────────────────────────────────────────
...
# Tổng tiền mỗi ngày mỗi customer
...
# Những ngày KHÔNG có strong auth
...
if log_df[log_df['status'] == 'FAIL'].empty:
    ...
    print("⚠️ Risky behavior detected. See logs/risk_check_log.csv and risk_tag_table.csv")
